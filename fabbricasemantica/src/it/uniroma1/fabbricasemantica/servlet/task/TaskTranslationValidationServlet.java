...
/**
 * Servlet per i dati inviati dalla pagina translationValidation
...
public class TaskTranslationValidationServlet extends BaseServlet {
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SAXException, ParserConfigurationException, TransformerException {
		...
		if(buttonNext != null && buttonNext.equals("NEXT")) TaskServletManager.check(ID, StandardTask.TRANSLATION_VALIDATION, request, response);
