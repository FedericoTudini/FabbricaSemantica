...
/**
 * Servlet per i dati inviati dalla pagina myAnnotation
...
public class TaskMyAnnotationServlet extends BaseServlet {
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SAXException, ParserConfigurationException, TransformerException {
		...
		if(buttonNext != null && buttonNext.equals("NEXT")) TaskServletManager.check(ID, StandardTask.MY_ANNOTATION, request, response);
