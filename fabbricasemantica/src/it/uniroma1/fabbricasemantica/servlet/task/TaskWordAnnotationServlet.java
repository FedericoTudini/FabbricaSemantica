...
/**
 * Servlet per i dati inviati dalla pagina wordAnnotation
...
public class TaskWordAnnotationServlet extends BaseServlet {
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SAXException, ParserConfigurationException, TransformerException {
		...
		if(buttonNext != null && buttonNext.equals("NEXT")) TaskServletManager.check(ID, StandardTask.WORD_ANNOTATION, request, response);
