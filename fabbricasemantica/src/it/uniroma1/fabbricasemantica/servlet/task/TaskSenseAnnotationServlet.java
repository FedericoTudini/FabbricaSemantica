...
/**
 * Servlet per i dati inviati dalla pagina senseAnnotation
...
public class TaskSenseAnnotationServlet extends BaseServlet {
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SAXException, ParserConfigurationException, TransformerException {
		...
		if(buttonNext != null && buttonNext.equals("NEXT")) TaskServletManager.check(ID, StandardTask.SENSE_ANNOTATION, request, response);
