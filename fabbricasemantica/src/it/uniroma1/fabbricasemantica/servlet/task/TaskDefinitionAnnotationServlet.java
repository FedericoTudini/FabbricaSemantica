...
/**
 * Servlet per i dati inviati dalla pagina definitionAnnotation
...
public class TaskDefinitionAnnotationServlet extends BaseServlet {
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SAXException, ParserConfigurationException, TransformerException {
		...
		if(buttonNext != null && buttonNext.equals("NEXT")) TaskServletManager.check(ID, StandardTask.DEFINITION_ANNOTATION, request, response);
